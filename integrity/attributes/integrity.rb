...
set_unless[:integrity][:path]         = "/home/timo/integrity"
set_unless[:integrity][:server_name]  = "ci"
set_unless[:integrity][:repo]         = "git://github.com/integrity/integrity"
set_unless[:integrity][:branch]       = "master"
set_unless[:integrity][:user]         = "timo"
set_unless[:integrity][:group]        = "www-data"
...
set_unless[:integrity][:notifiers]    = [:email]
